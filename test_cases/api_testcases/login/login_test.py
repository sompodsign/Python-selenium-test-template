...
from helpers.general_functions import assert_key_value_pairs
from test_data.login_data.data import valid_login_credentials, \
...
def test_valid_signin():
    ...
    assert_key_value_pairs(
        items={"message": 'User logged in successfully', "statusCode": 200, "role": "PLAYER"},
