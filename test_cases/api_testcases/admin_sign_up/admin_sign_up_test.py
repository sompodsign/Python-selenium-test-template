import allure
from test_data.admin_sign_up.data import new_admin, new_admin_existing_email, \
...
def test_successful_admin_sign_up():
    ...
    assert_key_value_pairs(items={"message": "Signed up successfully.", "success": True}, response=result["response"])
